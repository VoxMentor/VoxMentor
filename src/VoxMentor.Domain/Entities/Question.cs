...
public class Question
{
    ...
    /// <summary>Question kind, e.g. "Code" or "MCQ".</summary>
    public string QuestionType { get; set; } = "Code";
    ...
    /// <summary>Grading rubric entries (JSON {"criterion","points"} objects), one per string.</summary>
    public string[] Rubric { get; set; } = Array.Empty<string>();
